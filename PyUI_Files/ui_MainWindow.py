...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.get_blockchain_button = QPushButton(self.centralwidget)
        self.get_blockchain_button.setObjectName(u"get_blockchain_button")
        self.get_blockchain_button.setGeometry(QRect(10, 70, 121, 32))
        ...
        self.get_txHistory_button = QPushButton(self.centralwidget)
        self.get_txHistory_button.setObjectName(u"get_txHistory_button")
        self.get_txHistory_button.setGeometry(QRect(10, 100, 121, 32))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.get_blockchain_button.setText(QCoreApplication.translate("MainWindow", u"Get blocks history", None))
        ...
        self.get_txHistory_button.setText(QCoreApplication.translate("MainWindow", u"Get my Tx history", None))
    # retranslateUi
